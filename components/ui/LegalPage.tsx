export default function LegalPage({ title, subtitle, lastUpdated, children }: {
  title: string; subtitle: string; lastUpdated: string; children: React.ReactNode
}) {
  return (
    <>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <p className="mil-up mil-mb-60" style={{ fontSize:13, color:'rgba(0,0,0,0.35)', textTransform:'uppercase', letterSpacing:2, fontWeight:500 }}>
